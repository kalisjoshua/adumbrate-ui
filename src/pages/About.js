    ...
    <Layout>
      <div className="appIntro">
        ...
        <p>Adumbrate allows for brainstorming-like flexibility when identifying
          hierarchies of work milestones. Add simple titles for quick
          recognition, then add descriptions to more fully explain details or
          add notes that are important to remember later.</p>
        ...
        <p>Often times, the plan we start out with is not the exact work that
        gets completed due to learning or changing priorities along the way;
        having a "before" and "after" view of the plan can offer interesting
        insight into how we plan new work.</p>
      </div>
    </Layout>
  )
}
